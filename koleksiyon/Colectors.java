...
public class SetSinifi {
	...
	public static void main(String args[]){
		...
		hs.add("Armut");
		hs.add("Üzüm");
		hs.add("Üzüm"); //Ayný elemaný eklemiyor
		System.out.println(hs); //Yazarken rastgele yazdýrýyor.
		hs.remove("Üzüm");
		...
		ts.add(7);
		ts.add(9);
		ts.add(9); // Ayný eleman iki kere eklenmez
		System.out.println(ts); //Treeset sýralý yazdýrýlýr
		...
		while(i.hasNext()){
			System.out.println("Sýradaki eleman:" + i.next());
			i.remove();
		...
		while(j.hasNext()){
			System.out.println("HashSet teki sýradaki eleman: " + j.next());
			j.remove();
			System.out.println("Seçili eleman silindi");
		}
		...
		linked1.add("Dunya");
		linked1.add("Naber");
		linked1.add("Nasýlsýn");
		linked2.add("Sana");
		linked2.add("da");
		linked2.add("Merhaba");
		linked2.add("Ýyiyim");
		linked2.add("Elhamduillah");
		linked1.add(0,"Selamun Aleykum"); //Add komutuna indis verirsek verilen indise ekler, sonrakileri kaydýrýr
		...
		linked2.clear();
		System.out.println("linked2:" + linked2);
		System.out.println("linked1'in 3. elemaný:" + linked1.get(2));
		linked1.set(8,"Allah'a þükürler olsun");
		System.out.println("linked1:" + linked1);
		...
		System.out.println();
		System.out.println("linked1 de ilk \"Merhaba\" 'nýn indisi:" + ilkIndis(linked1,"Merhaba"));
		System.out.println("linked1 de son \"Merhaba\" 'nýn indisi:" + sonIndis(linked1,"Merhaba"));
		
		//Kuyruk - Queue
		Queue<String> kuyruk = new LinkedList<String>();
		kuyruk.offer("Pisa Kulesi");
		kuyruk.offer("Veliaða Hipodromu");
		kuyruk.offer("Eyfel Kulesi");
		System.out.println("kuyruk:" + kuyruk);
		System.out.println("kuyruktan silinen eleman:" + kuyruk.poll());
		System.out.println("poll uygulanmýþ kuyruk:" + kuyruk);
